...
export class WatercolorEngine {
    ...
    apply_silhouette_blend_brush(cx: number, cy: number, size: number, blend_strength: number, angle: number, pressure: number): void;
    apply_silhouette_blend_brush_stroke(x0: number, y0: number, x1: number, y1: number, size: number, blend_strength: number, velocity: number): void;
...
export interface InitOutput {
    ...
    readonly watercolorengine_apply_silhouette_blend_brush: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly watercolorengine_apply_silhouette_blend_brush_stroke: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;

...
export const watercolorengine_apply_background_brush: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
export const watercolorengine_apply_background_brush_stroke: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => void;
...
export const watercolorengine_new: (a: number, b: number) => number;
export const watercolorengine_render: (a: number) => [number, number];
export const watercolorengine_reset: (a: number) => void;
export const watercolorengine_set_physics: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const watercolorengine_set_pigment_props: (a: number, b: number, c: number) => void;
export const watercolorengine_set_show_texture: (a: number, b: number) => void;
export const watercolorengine_set_silhouette_controls: (a: number, b: number, c: number) => void;
export const watercolorengine_step: (a: number) => void;
